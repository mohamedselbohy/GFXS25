...
namespace our {
    ...
    {
    public:
        Texture2D *ambient_occlusion; // gets the ambient by multipying by albedo
        Texture2D *specular;          // object is shining
        Texture2D *roughness;         // help in set shining
        Texture2D *albedo;            // to represent the diffusion color
        Texture2D *emission;
        Sampler *sampler;
